...
@implementation SamiManifestPropertiesEnvelope
...
-(id) initWithValues:(NSDictionary*)dict
{
    ...
    if(self) {
        ...
        if(data_dict != nil)
            _data = [[SamiManifestProperties  alloc]initWithValues:data_dict];
...
-(NSDictionary*) asDictionary {
    ...
    if(_data != nil){
        if([_data isKindOfClass:[NSArray class]]){
            ...
            for( SamiManifestProperties *data in (NSArray*)_data) {
